...
L0:         ABS    tmp, tmp       ;Loopback point, one time step, 0.01 ms
            ...
            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,1,P1        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,2,P2        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,3,P3        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,4,P4        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,5,P5   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,6,P6        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,7,P7        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,8,P8        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,9,P9        ;If AREA = 2, play waveform area 2 instead of 1            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,10,PA        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,11,PB        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,12,PC        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,13,PD        ;If AREA = 2, play waveform area 2 instead of 1            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,14,PE        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,15,PF        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,16,P10        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,17,P11        ;If AREA = 2, play waveform area 2 instead of 1            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,18,P12        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,19,P13        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,20,P14        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,21,P15        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,22,P16        ;If AREA = 2, play waveform area 2 instead of 1            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,23,P17        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,24,P18        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,25,P19        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,26,P1A        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,27,P1B        ;If AREA = 2, play waveform area 2 instead of 1            BEQ    V65,0,P0   ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,28,P1C        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,29,P1D        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,30,P1E        ;If AREA = 2, play waveform area 2 instead of 1
            BEQ    V65,31,P1F        ;If AREA = 2, play waveform area 2 instead of 1
